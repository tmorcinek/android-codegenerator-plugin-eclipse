package com.morcinek.android.codegenerator.plugin.layouts.adapter.action;
 ...
 */
public class AdapterAction implements IObjectActionDelegate {
    ...
    public void run(IAction iAction) {
        ...
        new AdapterActionHandler().handleAction(file, window);
        workbenchPart = null;
    }
